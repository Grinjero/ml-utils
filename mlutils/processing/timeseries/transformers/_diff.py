...
class Differencer(_SeriesToSeriesTransformer):
    ...
    def _transform(self, Z, X=None):
        ...
        # check if there is at least one value available before the start of Z
    ...
    def _inverse_transform(self, Z, X=None, is_future=False):
        ...
        if is_contained_by_fit_z and is_future is False:
    ...
    def inverse_transform(self, Z, X=None, is_future=False):
        ...
        Z_inv = self._inverse_transform(Z, X=X, is_future=is_future)
        return Z_inv
